...
mkdir tmp
wget -P /tmp https://github.com/nirui/sshwifty/releases/download/0.3.19-beta-release-prebuild/sshwifty_0.3.19-beta-release_linux_amd64.tar.gz
tar -zxvf sshwifty_0.3.19-beta-release_linux_amd64.tar.gz -C /tmp
